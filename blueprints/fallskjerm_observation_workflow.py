...
@OrsWorkflow.route('/<objectid:observation_id>/<regex("(approve|reject|withdraw|reopen|approve_fs_aff|approve_fs_skjerm|approve_fs_tandem|approve_fs_aff|approve_fs_leder)"):action>', methods=['POST'])
@require_token()
