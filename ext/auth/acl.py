...
def get_user_permissions(_id, collection):
    ...
    """
    try:
        if collection not in ['fallskjerm_observations', 'motorfly_observations', 'seilfly_observations', 'sportsfly_observations', 'modellfly_observations', 'hps_observations', 'users']:
