...
def get_wf_init(person_id):
    ...
    return {'name': 'modellfly_observations_workflow',
...
class ObservationWorkflow(Machine):
    ...
    def __init__(self, object_id=None, initial_state=None, user_id=None, comment=None):
        ...
        self._states = WF_MODELLFLY_STATES

        self._state_attrs = WF_MODELLFLY_ATTR
        ...
        """
        self._transitions = WF_MODELLFLY_TRANSITIONS
        ...
        """
        self._trigger_attrs = WF_MODELLFLY_TRANSITIONS_ATTR
        ...
        self.ors = ACL_MODELLFLY_ORS.copy()
        ACL_MODELLFLY_ORS['org'] = self.discipline
    ...
    def get_resources(self):
        ...
        for event in self.get_actions():
            ...
            try:
                ...
                app.logger.exception('Error in wf_modellfly.get_resources')
    ...
    def set_acl(self):
        ...
        if self.state == 'draft':
            ...
            acl['read']['roles'] += [ACL_MODELLFLY_ORS]
            acl['write']['roles'] = []
            acl['execute']['roles'] = []
            ...
            acl['write']['roles'] = [ACL_MODELLFLY_ORS]
            acl['read']['roles'] += [ACL_MODELLFLY_ORS, ACL_MODELLFLY_FSJ]
            acl['execute']['roles'] = [ACL_MODELLFLY_ORS]
    ...
    def notification(self, action=None, context='transition'):
        ...
        if action is None:
            action = WF_MODELLFLY_TRANSITIONS_ATTR[self.action]['resource']
        ...
        ors_workflow(
            ...
            action=action,  # WF_MODELLFLY_TRANSITIONS_ATTR[action]['action'],
